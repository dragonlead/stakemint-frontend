...
export const lightColors = {
  ...
  textSubtle: '#282F39',
  disabled: '#E9EAEB',
  gradientBubblegum: 'linear-gradient(139.73deg, #D5D5D5 0%, #EFEFEF 100%)',
  gradientInverseBubblegum: 'linear-gradient(139.73deg, #EFEFFF 0%, #FAF9FA 100%)',
...
export const darkColors = {
  ...
  backgroundAlt: '#282F39',
  backgroundAlt2: '#1C212B',
  cardBorder: '#282F39',
  contrast: '#FFFFFF',
  dropdown: '#1E1D20',
  dropdownDeep: '#100C18',
  ...
  textSubtle: '#FDF7F9',
  disabled: '#524B63',
  gradientBubblegum: 'linear-gradient(139.73deg, #11141D 0%, #282F39 100%)',
  gradientInverseBubblegum: 'linear-gradient(139.73deg, #282F39 0%, #11141D 100%)',
